...
export default function WhyChooseUs() {
  ...
  const features = [
    {
      ...
      description:
        "Lorem ipsum dolor sit amet adipisicing elit. Quas dolores nam ipsum odit quod fuge numquam hic quo!",
    },
    {
      id: "dedicated-team",
      title: "Dedicated Team",
      description:
        "Our team is committed to your success with personalized attention and support throughout your journey with us.",
    },
    {
      id: "outcome-focused",
      title: "Outcome Focused",
      description:
        "We prioritize results that matter to your business, focusing on deliverables that drive real value and growth.",
    },
    {
      id: "high-quality-service",
      title: "High Quality Service",
      description:
        "Excellence is our standard, delivering premium solutions that exceed expectations and stand the test of time.",
    },
    {
      id: "cyber-security-expert",
      title: "Cyber Security Expert",
      description:
        "Protect your digital assets with our advanced security protocols and industry-leading expertise in threat prevention.",
    },
  ];
  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center mt-8 md:mt-12">
